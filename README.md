...
8. [Machine campaign catalog](public/hodlmm/campaigns/catalog.json) — terminal states, entry-gate state, and receipt counts, including the armed but unopened Campaign 004.
